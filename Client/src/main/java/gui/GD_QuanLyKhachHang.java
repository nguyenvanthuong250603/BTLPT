...
public class GD_QuanLyKhachHang extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		cbBoxDT.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { " ", "Trẻ em", "Người lớn", "Sinh viên", "Người cao tuổi" }));
	...
	private void addDataTable(List<KhachHang> list) {
		...
		for (KhachHang khachHang : list) {
			Object[] row = { khachHang.getCccd(), khachHang.getHoTen(),
					(khachHang.getEmail() == null ? "" : khachHang.getEmail()),
					(khachHang.getSdt() == null ? "" : khachHang.getSdt()), khachHang.getDoiTuong()};
			model.addRow(row);
		}
