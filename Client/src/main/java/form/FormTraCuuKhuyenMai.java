...
public class FormTraCuuKhuyenMai extends javax.swing.JPanel {
	...
	private void addDataTable(List<KhuyenMai> list) {
		...
		for (KhuyenMai khuyenMai : list) {
			Object[] row = { khuyenMai.getMaKhuyenMai(), khuyenMai.getTenKhuyenMai(), khuyenMai.getLoaiKhuyenMai(),
					khuyenMai.getSoLuongVe(), khuyenMai.getThoiGianBatDau(), khuyenMai.getThoiGianKetThuc(),
					khuyenMai.getChietKhau(), khuyenMai.isTrangThai() ? "Đang áp dụng" : "Tạm ngưng" };
			model.addRow(row);
		}
	...
	private void initComponents() {
		...
		tableTraCuuKM.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String[] { "Mã khuyến mãi", "Tên khuyến mãi", "Loại khuyến mãi", "Số lượng vé",
						"Ngày bắt đầu khuyến mãi", "Ngày ngày kết thúc khuyến mãi", "Chiết khấu", "Trạng thái" }));
		...
		jMessLayout.setHorizontalGroup(jMessLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGap(0, 19, Short.MAX_VALUE));
		jMessLayout.setVerticalGroup(jMessLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		formThongTinLayout.setHorizontalGroup(formThongTinLayout
				...
				.addGroup(formThongTinLayout.createSequentialGroup().addContainerGap().addGroup(formThongTinLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, formThongTinLayout.createSequentialGroup()
								...
								.addComponent(btnXoaTrang, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(60, 60, 60))))
				.addGroup(formThongTinLayout.createSequentialGroup().addGap(177, 177, 177)
						.addComponent(jMess, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(0, 0, Short.MAX_VALUE)));
